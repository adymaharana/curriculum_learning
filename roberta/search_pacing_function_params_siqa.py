    ...
    if args.cl:
        def roberta_wrapper(starting_percent, inc, step_length):
            ...
            base_args_list = ['--model_type', 'roberta',
                              ...
                              '--train_file', 'train_with_scores.jsonl',
                              '--eval_file', 'dev.jsonl',
                              '--data_dir', './drive/MyDrive/Colab Notebooks/socialiqa/',
                              '--output_dir', './drive/MyDrive/Colab Notebooks/out/siqa-roberta-large/qap-cl-' + str(starting_percent) + '-' + str(inc) + '-' + str(step_length),
                              '--logging_steps', '50',
                              '--log_file', 'siqa_qap_cl.jsonl',
        ...
        def roberta_wrapper(starting_percent, inc, step_length, alpha):
            ...
            base_args_list = ['--model_type', 'roberta',
                              ...
                              '--eval_file', 'dev.jsonl',
                              '--train_logits_file', './baselines/siqa-roberta-large/checkpoint-best_train_logits.txt',
                              '--data_dir', '/ssd-playpen/home/adyasha/projects/data/siqa',
                              '--output_dir', '/nas-hdd/tarbucket/adyasha/models/siqa-roberta-large/qap-cl-' + str(starting_percent) + '-' + str(inc) + '-' + str(step_length) + '-' + str(alpha),
                              '--logging_steps', '50',
                              '--log_file', 'siqa_qap_cl.jsonl',
        ...
        def roberta_wrapper(learning_rate):
            """Wrapper of RoBERTa training and validation.
            ...
            base_args_list = ['--model_type', 'roberta',
                              ...
                              '--train_logits_file', './baselines/siqa-roberta-large/checkpoint-best_train_logits.txt',
                              '--data_dir', '/ssd-playpen/home/adyasha/projects/data/siqa',
                              '--output_dir', '/nas-hdd/tarbucket/adyasha/models/siqa-roberta-large/qap-cl-' + learning_rate,
                              '--logging_steps', '50',
                              '--log_file', 'siqa_qap_cl_hp.jsonl',
                              '--do_train', '--do_eval', '--curriculum_learning',
        ...
        eval_accs = []
        for lr in ['1e-6', '2e-6', '4e-6', '6e-6', '8e-6', '1e-5']:
            acc = roberta_wrapper(lr)
