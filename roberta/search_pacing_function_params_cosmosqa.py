    ...
    if args.cl:
        def roberta_wrapper(starting_percent, inc, step_length):
            ...
            base_args_list = ['--model_type', 'roberta',
                              ...
                              '--train_logits_file', './baselines/cosmosqa-roberta-large/best/checkpoint-12000/_train_logits.txt',
                              '--data_dir', '../../data/cosmosqa/',
                              '--output_dir', '/nas-hdd/tarbucket/adyasha/models/cosmosqa-roberta-large/qap-cl-' + str(starting_percent) + '-' + str(inc) + '-' + str(step_length),
                              '--logging_steps', '50',
                              '--log_file', 'cosmosqa_qap_cl.jsonl',
        ...
        def roberta_wrapper(starting_percent, inc, step_length, alpha):
            ...
            base_args_list = ['--model_type', 'roberta',
                              ...
                              '--eval_file', 'valid.jsonl',
                              '--train_logits_file', './baselines/cosmosqa-roberta-large/best/checkpoint-12000/_train_logits.txt',
                              '--data_dir', '/ssd-playpen/home/adyasha/projects/data/cosmosqa',
                              '--output_dir', '/nas-hdd/tarbucket/adyasha/models/cosmosqa-roberta-large/qap-cl-' + str(starting_percent) + '-' + str(inc) + '-' + str(step_length) + '-' + str(alpha),
                              '--logging_steps', '50',
                              '--log_file', 'cosmosqa_qap_cl.jsonl',
